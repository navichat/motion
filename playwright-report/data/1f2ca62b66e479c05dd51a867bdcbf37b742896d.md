...
- text: "Waiting for tasks... Task Management Engine Demo loaded. Ready to run tests and demonstrations. Click \"Run Full Test Suite\" to test all components Click \"Quick Demo\" for a fast demonstration Click \"Interactive Demo\" to manually control tasks Console output will appear here... [11:20:39 PM] 🎯 Task Management Engine Demo Ready! [11:20:39 PM] 🤖 AI Models: DeepMimic, FaceFormer, Audio2Gesture, RSMT, Kokoro, Whisper, VAD, TinyLlama, DiabloGPT [11:20:39 PM] 🔍 KNN Models: CloseVector, HNSW, UnifiedKNN for accuracy vs speed benchmarking [11:20:39 PM] Click the buttons above to start testing"
```