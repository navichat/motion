 ...
 * 
 * @see dev/web_viewer/docs/AI_INFERENCE_COLLECTION.md for complete documentation
 * @see dev/web_viewer/docs/TESTING_INFRASTRUCTURE.md for testing framework details
 * @see dev/web_viewer/REORGANIZATION_COMPLETE.md for project structure overview
 */
...
test('Capture and Save All AI Model Results', async ({ page }) => {
  ...
  await page.goto('http://localhost:8080/dev/web_viewer/demos/ai-inference/task-manager-demo.html');
